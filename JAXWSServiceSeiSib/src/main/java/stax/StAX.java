...
public class StAX {
    ...
    public void marshall(Hostel inputHostel, String filePath) {
        ...
        try {
            ...
            //xmlStreamWriter = new IndentingXMLStreamWriter(xmlOutputFactory.createXMLStreamWriter(streamWriter));
            xmlStreamWriter = new IndentingXMLStreamWriter(xmlOutputFactory.createXMLStreamWriter(new FileOutputStream(filePath)));
